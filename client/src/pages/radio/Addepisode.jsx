  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Swal.fire({
        icon: "success",
        title: "Success!",
        text: "New Episode added successfully.",
      });
      ...
      Swal.fire({
        icon: "error",
        title: "Error!",
        text: "An error occurred while adding the Episode.",
      });
      setsaving(false);
    }
  };
              ...
              decoded.permissions?.includes("addradio") ? (
                <div className="container-xxl flex-grow-1 container-p-y">
                  <h4 className="py-3 mb-4">
                    <span className="text-muted fw-light">Season/</span> Add
                    Episode
                  </h4>
                        ...
                        <div className="col-12 col-md-6">
                          <div className=" p-3 addradio-form-main">
                            ...
                            >
                              ...
                              <div className="mb-3  col-12">
                                <label className="form-label">
                                  Episode <span className="text-danger">*</span>
                                </label>
                                <div className="input-group mb-3">
                                  <span
                                    className="input-group-text"
